    ...
    */
    describe('RSS Feeds', function() {
        ...
        it('URL defined and that the URL is not empty', function() {
            let fURL = allFeeds;
            for(var x = 0; x < fURL.length; x++) { 
                expect(fURL[x].url).toBeDefined();
                expect(fURL[x].url.length).not.toBe(0);
            }
        });
        ...
        it('name defined and that the name is not empty', function() {
            ...
            for(var x = 0; x < fName.length; x++) {
                expect(fName[x].name).toBeDefined();
                expect(fName[x].name.length).not.toBe(0);
            }
        });
    });
    ...
    describe('The Menu', function() {
        ...
        it('hides the menu', function() {
          ...
          */
        it('makes the menu appear or disappear', function() {            
    ...
    describe('New Feed Selection', function() {
        ...
        beforeEach(function(done) {
            loadFeed(0, function() {
                feed1 = document.querySelector('.feed').innerHTML; // first entry
                loadFeed(1, function() {
                    feed2 = document.querySelector('.feed').innerHTML; // second entry           
                    done();
                });
            });
        });
         ...
         */
         it('content changes', function() {
            expect(feed1).not.toBe(feed2); //comparing of feeds          
         });
